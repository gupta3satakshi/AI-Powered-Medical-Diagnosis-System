...
background_image_url = "https://d2jx2rerrg6sh3.cloudfront.net/images/news/ImageForNews_776422_17123165547518811.jpg"  # Replace with your image URL
...
models = {
    'diabetes': pickle.load(open('C:/Users/Satakshi Gupta/OneDrive/Desktop/major project/Medical diagnosis using AI/Models/diabetes_model.sav', 'rb')),
...
if selected == 'Diabetes Prediction':
   ...
   # Insulin = display_input('Insulin Level', 'Enter insulin level', 'Insulin', 'number')
    ...
    if st.button('Diabetes Test Result'):
        diab_prediction = models['diabetes'].predict([[Glucose, BloodPressure,  BMI, Age]])
